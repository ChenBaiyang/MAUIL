...
#        print('len(alias_edges) in  node2vec_walk:',len(alias_edges))
#        pickle.dump(alias_edges,open('d:/alias_walk','wb'))
        walk = [start_node]
...
#        print('len(alias_edges) in preprocess:',len(alias_edges))
#        pickle.dump(alias_edges,open('d:/alias_pre','wb'))
